...
package com.willaapps.cryptotracker.crypto.presentation.coin_detail
...
import com.willaapps.cryptotracker.R
import com.willaapps.cryptotracker.crypto.presentation.coin_detail.components.InfoCard
import com.willaapps.cryptotracker.crypto.presentation.coin_list.CoinListState
import com.willaapps.cryptotracker.crypto.presentation.coin_list.components.previewCoin
import com.willaapps.cryptotracker.crypto.presentation.models.toDisplayableNumber
import com.willaapps.cryptotracker.ui.theme.CryptoTrackerTheme
import com.willaapps.cryptotracker.ui.theme.greenBackground
    ...
    if (state.isLoading) {
        ...
        Column(
            ...
            AnimatedVisibility(
                ...
                var totalCharWidth by remember {
                    mutableFloatStateOf(0f)
                }
                val amountOfVisibleDataPoints = if (labelWidth > 0) {
                    ((totalCharWidth - 2.5 * labelWidth) / labelWidth).toInt()
                } else {
                    0
                }
                ...
                LineChart(
                    ...
                    modifier = Modifier
                        .fillMaxWidth()
                        .aspectRatio(16 / 9f)
                        .onSizeChanged { totalCharWidth = it.width.toFloat() },
